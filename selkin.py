...
<title>سەلكىن توربېتىنىڭ https://archive.org دىن ئەسلىگە كەلتۈرۈلگەن يازمىلىرى</title>
</head>
<body>
<h3 align="center">سەلكىن توربېتىنىڭ https://archive.org دىن ئەسلىگە كەلتۈرۈلگەن يازمىلىرى</h3>
...
srcdir   = R'salkin\bbs_salkin'
targetdir = R'salkin\pages'

remove_title = [
    '- Powered Uyghur by UYPW Code © 2008-09',
    '- for Uighur by Kroran Code © 2007-03',
    'salkin.cn - salkin Resources and Information. This website is for sale!',
    'for Uyghur by UYPW Code © 2008-01',
    'Powered Uyghur by Salkin Code © 2009-01',
]

remove_urls = ['http://bbs.salkin.cn/','http://www.diyarim.com/',]
