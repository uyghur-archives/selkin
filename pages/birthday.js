...
function init(d_start,d_end)
{
     ...
     temp_str+="<font color=red>ية</font></td><td>";temp_str+="دى</td><td>"; temp_str+="سة</td><td>"; temp_str+="حا</td><td>"
     temp_str+="صة</td><td>";temp_str+="جى</td><td>"; temp_str+="شة</td></tr>";
     for (i=1 ;i<=6 ;i++)
     {
     temp_str+="<tr>";
        for(j=1;j<=7;j++){
